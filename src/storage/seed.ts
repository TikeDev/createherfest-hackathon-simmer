...
const DEMO_RECIPES: RecipeJSON[] = [
  ...
  // ── Score 2: Korean Bulgogi (requires 2-4 hour marinade) ────────────────
  {
    id: "demo-korea-bulgogi",
    title: "Bulgogi (Korean Marinated Beef)",
    sourceDomain: "demo",
    extractedAt: "2026-03-07T10:00:00.000Z",
    preamble: {
      raw: "Bulgogi is Korea's most famous BBQ dish — thinly sliced beef marinated in a sweet-savory sauce of soy, pear, and sesame. The pear tenderizes the meat naturally. Marinating is essential; don't skip it or rush it.",
      tips: [
        "Freeze the beef for 30 minutes before slicing — it's much easier to cut thin.",
        "Asian pear is traditional, but a ripe regular pear works fine.",
        "For best results, marinate overnight. Minimum 2 hours.",
      ],
      substitutions: [
        {
          original: "ribeye",
          substitute: "sirloin or flank steak",
          note: "Slice against the grain as thinly as possible.",
          sourceNote: "preamble",
        },
      ],
      techniqueNotes: [
        "The sugar in the marinade caramelizes quickly — watch for burning if using high heat.",
      ],
    },
    ingredients: [
      {
        id: "ing-bg-1",
        raw: "500g ribeye or sirloin, sliced very thin",
        name: "ribeye beef",
        quantity: 500,
        unit: "g",
        units: [{ original: "500g", grams: 500, confidenceLevel: "high" }],
        category: "Protein",
      },
      {
        id: "ing-bg-2",
        raw: "1 Asian pear, grated (or ½ regular pear)",
        name: "Asian pear",
        quantity: 1,
        unit: null,
        units: [{ original: "1 pear", grams: 180, confidenceLevel: "medium" }],
        category: "Produce",
      },
      {
        id: "ing-bg-3",
        raw: "4 tablespoons soy sauce",
        name: "soy sauce",
        quantity: 4,
        unit: "tablespoon",
        units: [{ original: "4 tablespoons", mlEquivalent: 60, confidenceLevel: "high" }],
        category: "Pantry",
      },
      {
        id: "ing-bg-4",
        raw: "2 tablespoons brown sugar",
        name: "brown sugar",
        quantity: 2,
        unit: "tablespoon",
        units: [{ original: "2 tablespoons", grams: 28, confidenceLevel: "high" }],
      ...
      {
        id: "ing-bg-5",
        raw: "1 tablespoon sesame oil",
        name: "sesame oil",
        quantity: 1,
        unit: "tablespoon",
        units: [{ original: "1 tablespoon", mlEquivalent: 15, confidenceLevel: "high" }],
        category: "Oils & Vinegars",
      },
      {
        id: "ing-bg-6",
        ...
        quantity: 4,
        unit: "clove",
        units: [{ original: "4 cloves", confidenceLevel: "high" }],
        category: "Produce",
      },
      {
        id: "ing-bg-7",
        ...
        quantity: 1,
        unit: "inch",
        units: [{ original: "1-inch piece", grams: 8, confidenceLevel: "medium" }],
        category: "Produce",
      },
      {
        id: "ing-bg-8",
        raw: "2 green onions, sliced (plus more for garnish)",
        name: "green onions",
        quantity: 2,
        unit: null,
        units: [{ original: "2 stalks", confidenceLevel: "high" }],
      ...
      {
        id: "ing-bg-9",
        raw: "1 tablespoon vegetable oil for cooking",
        name: "vegetable oil",
        quantity: 1,
        unit: "tablespoon",
        units: [{ original: "1 tablespoon", confidenceLevel: "high" }],
        category: "Oils & Vinegars",
      },
      {
        id: "ing-bg-10",
    ...
    steps: [
      {
        id: "step-bg-1",
        index: 1,
        text: "In a large bowl, combine grated pear, soy sauce, brown sugar, sesame oil, garlic, ginger, and green onions. Whisk until the sugar dissolves.",
        isCritical: false,
        annotations: [],
      },
      {
        id: "step-bg-2",
        index: 2,
        text: "Add the sliced beef to the marinade. Toss to coat every piece evenly. Cover and refrigerate for at least 2 hours, or overnight for best results.",
        timingMinutes: 120,
        isCritical: true,
        criticalNote: "Marinating is essential — minimum 2 hours, overnight is best. The pear enzymes tenderize the meat.",
        annotations: [
          {
            type: "tip",
            text: "Plan ahead: start the marinade in the morning for dinner, or the night before.",
          },
        ],
      },
      {
        id: "step-bg-3",
        index: 3,
        text: "Heat vegetable oil in a large skillet or grill pan over high heat until shimmering.",
        isCritical: false,
        annotations: [],
      },
      {
        id: "step-bg-4",
        index: 4,
        text: "Working in batches to avoid crowding, cook the beef for 2-3 minutes per side until caramelized and cooked through.",
        timingMinutes: 6,
        isCritical: false,
        annotations: [
          {
            type: "technique",
            text: "Don't overcrowd the pan — the meat should sizzle, not steam. Cook in 2-3 batches.",
          },
        ],
      },
      {
        id: "step-bg-5",
        index: 5,
        text: "Transfer to a serving plate. Garnish with sliced green onions and sesame seeds. Serve with steamed rice.",
        isCritical: false,
        annotations: [],
      },
    ],
  ...
  // ── Score 1: Overnight Oats (passive overnight prep) ────────────────
  {
    id: "demo-overnight-oats",
    title: "Overnight Oats with Berries",
    sourceDomain: "demo",
    extractedAt: "2026-03-07T11:00:00.000Z",
    preamble: {
      raw: "The ultimate low-effort breakfast — mix everything the night before, wake up to a ready meal. No cooking required. The oats soften overnight in the fridge, absorbing the liquid and flavors.",
      tips: [
        "Use a jar with a lid for easy storage and transport.",
        "Old-fashioned rolled oats work best. Quick oats get too mushy.",
        "Add fresh toppings in the morning for the best texture.",
      ],
      substitutions: [
        {
          original: "milk",
          substitute: "any plant milk (oat, almond, soy)",
          note: "All work equally well.",
          sourceNote: "preamble",
        },
        {
          original: "Greek yogurt",
          substitute: "coconut yogurt or skip entirely",
          note: "Yogurt adds creaminess and protein but isn't essential.",
          sourceNote: "preamble",
        },
      ],
      techniqueNotes: [],
    ...
    ingredients: [
      {
        ...
        quantity: 0.5,
        unit: "cup",
        units: [{ original: "½ cup", grams: 45, confidenceLevel: "high" }],
        category: "Pantry",
      },
      {
        id: "ing-oo-2",
        raw: "½ cup milk of choice",
        name: "milk",
        quantity: 0.5,
        unit: "cup",
        units: [{ original: "½ cup", mlEquivalent: 120, confidenceLevel: "high" }],
        category: "Dairy",
      },
      {
        id: "ing-oo-3",
        ...
        quantity: 0.25,
        unit: "cup",
        units: [{ original: "¼ cup", grams: 60, confidenceLevel: "high" }],
        category: "Dairy",
      },
      {
        id: "ing-oo-4",
        raw: "1 tablespoon honey or maple syrup",
        name: "honey",
        quantity: 1,
        unit: "tablespoon",
        units: [{ original: "1 tablespoon", grams: 21, confidenceLevel: "high" }],
        category: "Pantry",
      },
      {
        id: "ing-oo-5",
        raw: "1 tablespoon chia seeds (optional)",
        name: "chia seeds",
        quantity: 1,
        unit: "tablespoon",
        units: [{ original: "1 tablespoon", grams: 12, confidenceLevel: "high" }],
        category: "Pantry",
      },
      {
        id: "ing-oo-6",
        raw: "½ cup mixed berries (fresh or frozen)",
        name: "mixed berries",
        quantity: 0.5,
        unit: "cup",
        units: [{ original: "½ cup", grams: 75, confidenceLevel: "high" }],
        category: "Produce",
      },
      {
        id: "ing-oo-7",
        ...
        quantity: null,
        unit: null,
        units: [{ original: "pinch", confidenceLevel: "high" }],
        category: "Spices & Seasonings",
      },
    ],
    steps: [
      {
        id: "step-oo-1",
        index: 1,
        text: "In a jar or container, combine oats, milk, yogurt, honey, chia seeds (if using), and salt. Stir well.",
        isCritical: false,
        annotations: [],
      },
      {
        id: "step-oo-2",
        index: 2,
        text: "Add half the berries and stir gently.",
        isCritical: false,
        annotations: [],
      },
      {
        ...
        timingMinutes: 480,
        isCritical: true,
        criticalNote: "The oats need time to absorb the liquid — minimum 4 hours, overnight is ideal.",
        annotations: [
          {
            type: "tip",
            text: "Prep Sunday night for easy Monday breakfast. Lasts 3-4 days in the fridge.",
          },
        ],
      },
      {
        id: "step-oo-4",
        index: 4,
        text: "In the morning, stir and top with remaining fresh berries. Eat cold or microwave for 1-2 minutes if you prefer warm oats.",
        isCritical: false,
        annotations: [],
      },
    ],
    metadata: {
      totalTimeMinutes: 485,
      prepTimeMinutes: 5,
      cookTimeMinutes: 0,
      servings: "1",
      cognitiveScore: 1,
  ...
  // ── Score 2: Chicken Tikka (requires 2-6 hour marinade) ────────────────
  {
    id: "demo-india-chicken-tikka",
    title: "Chicken Tikka (Indian Spiced Grilled Chicken)",
    sourceDomain: "demo",
    extractedAt: "2026-03-07T12:00:00.000Z",
    preamble: {
      raw: "Chicken tikka is marinated in yogurt and spices, then grilled or broiled until charred at the edges. The yogurt tenderizes the chicken while the spices infuse deep flavor. This is the base for chicken tikka masala, but it's delicious on its own.",
      tips: [
        "Cut the chicken into even 1.5-inch pieces for consistent cooking.",
        "Longer marinating = deeper flavor. 2 hours minimum, 6 hours is ideal.",
        "High heat is essential for the charred edges — use broiler or very hot grill.",
      ],
      substitutions: [
        {
          original: "chicken thighs",
          substitute: "chicken breast",
          note: "Breast works but is less forgiving — don't overcook.",
          sourceNote: "preamble",
        },
      ],
      techniqueNotes: [
        "The yogurt marinade is acidic — don't marinate longer than 24 hours or the texture becomes mushy.",
      ],
    },
    ingredients: [
      {
        id: "ing-ct-1",
        raw: "600g boneless chicken thighs, cut into 1.5-inch pieces",
        name: "chicken thighs",
        quantity: 600,
        unit: "g",
        units: [{ original: "600g", grams: 600, confidenceLevel: "high" }],
        category: "Protein",
      },
      {
        id: "ing-ct-2",
        raw: "1 cup plain yogurt",
        name: "plain yogurt",
        quantity: 1,
        unit: "cup",
        units: [{ original: "1 cup", grams: 245, confidenceLevel: "high" }],
        category: "Dairy",
      },
      {
        id: "ing-ct-3",
        raw: "2 tablespoons lemon juice",
        name: "lemon juice",
        quantity: 2,
        unit: "tablespoon",
        units: [{ original: "2 tablespoons", mlEquivalent: 30, confidenceLevel: "high" }],
      ...
      {
        id: "ing-ct-5",
        raw: "1-inch piece ginger, grated",
        name: "fresh ginger",
        quantity: 1,
        unit: "inch",
        units: [{ original: "1-inch piece", grams: 8, confidenceLevel: "medium" }],
      ...
      {
        id: "ing-ct-6",
        raw: "2 teaspoons garam masala",
        name: "garam masala",
        quantity: 2,
        unit: "teaspoon",
        units: [{ original: "2 teaspoons", grams: 5, confidenceLevel: "high" }],
        category: "Spices & Seasonings",
      },
      {
        id: "ing-ct-7",
      ...
      {
        id: "ing-ct-10",
        raw: "½ teaspoon cayenne pepper (adjust to taste)",
        name: "cayenne pepper",
        quantity: 0.5,
        unit: "teaspoon",
        units: [{ original: "½ teaspoon", confidenceLevel: "high" }],
      ...
      },
      {
        ...
        quantity: 1,
        unit: "teaspoon",
        units: [{ original: "1 teaspoon", grams: 6, confidenceLevel: "high" }],
        category: "Spices & Seasonings",
      },
      {
        id: "ing-ct-12",
      ...
      {
        id: "ing-ct-13",
        raw: "Fresh cilantro and lemon wedges, to serve",
        name: "cilantro",
        quantity: null,
        unit: null,
        units: [{ original: "to serve", confidenceLevel: "high" }],
        category: "Produce",
      },
    ],
    steps: [
      {
        id: "step-ct-1",
        index: 1,
        text: "In a large bowl, combine yogurt, lemon juice, garlic, ginger, garam masala, cumin, paprika, turmeric, cayenne, salt, and oil. Mix well into a smooth marinade.",
        isCritical: false,
        annotations: [],
      },
      {
        id: "step-ct-2",
        index: 2,
        text: "Add chicken pieces and toss until every piece is well coated. Cover and refrigerate for at least 2 hours, or up to 6 hours for best flavor.",
        timingMinutes: 120,
        isCritical: true,
        criticalNote: "Marinating is essential — minimum 2 hours. The yogurt tenderizes while spices infuse.",
        annotations: [
          {
            type: "tip",
            text: "Start the marinade before work; it'll be ready for dinner.",
          },
        ],
      },
      {
        id: "step-ct-3",
        index: 3,
        text: "Preheat your broiler to high, or heat a grill to high heat. If using oven, line a baking sheet with foil and place a wire rack on top.",
        isCritical: false,
        annotations: [],
      },
      {
        id: "step-ct-4",
        index: 4,
        text: "Thread chicken onto skewers (if using) or spread pieces on the wire rack. Shake off excess marinade.",
        isCritical: false,
        annotations: [],
      },
      {
        id: "step-ct-5",
        index: 5,
        text: "Broil or grill for 5-6 minutes per side until charred at edges and cooked through (internal temp 165°F/75°C).",
        timingMinutes: 12,
        isCritical: true,
        criticalNote: "Chicken must reach 165°F/75°C internal temperature. Cut one piece to check — no pink inside.",
        annotations: [],
      },
      {
        id: "step-ct-6",
        index: 6,
        text: "Rest for 2 minutes, then serve with fresh cilantro and lemon wedges. Excellent with naan bread or rice.",
        isCritical: false,
        annotations: [],
      },
    ],
